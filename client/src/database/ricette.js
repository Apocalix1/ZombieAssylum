...
const RICETTE = {
    facile: [
        ...
        { nome: "Integratori", cd: 12, costo: 6, tempo: 3, desc: "+3 ai tiri basati su Intelligenza, Saggezza e ai tiri per Studiare per 1 ora.", effetto: { tipo: 'bonus_abilità', bonus: 3, skills: ['Intelligenza', 'Saggezza', 'Studio'], durata: 1 } },
